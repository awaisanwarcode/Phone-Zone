...
export const SamsungPrdct = () => {
    let { allItems, cartData, AddToCart, SubFrmCart } = useContext(StoreContext);
    let SumsangProducts;
    if (allItems) {
        SumsangProducts = allItems.filter((v, i) => { if (v.company === "Samsung") { return v } })
    }
    return (
        <>
            <div className="sngleCompnyPrdct" id="Samsung">
                <div>
                    <h3 className="cmpny-name">Sumsang Company</h3>
